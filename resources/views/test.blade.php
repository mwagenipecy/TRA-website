...
<head>
    ...
    <title>@yield('title', 'TRA Clubs Management System')</title>
...
<body class="bg-white font-sans">
                ...
                <div class="flex justify-between items-center h-10 sm:h-12">
                    ...
                    <div class="flex items-center space-x-4 text-sm">
                        <div class="hidden lg:flex items-center space-x-4">
                            ...
                            <a href="{{ route('dashboard') }}" class="hover:text-white transition-colors duration-300 flex items-center space-x-1">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-white border-b border-gray-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16 sm:h-20">
                    ...
                    <div class="flex items-center space-x-3 sm:space-x-4 animate-fade-in-left">
                        ...
                        <a href="{{ route('home') }}" class="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div class="flex items-center space-x-6 lg:space-x-8">
                        ...
                        <div class="hidden lg:flex items-center space-x-6 xl:space-x-8 animate-fade-in-up">
                            <a href="{{ route('home') }}" class="nav-link group relative px-4 py-2 text-tra-black hover:text-tra-yellow transition-all duration-300 font-semibold text-base {{ request()->routeIs('home') ? 'text-tra-yellow' : '' }}">
                            ...
                            <a href="{{ route('about') }}" class="nav-link group relative px-4 py-2 text-tra-black hover:text-tra-yellow transition-all duration-300 font-semibold text-base {{ request()->routeIs('about') ? 'text-tra-yellow' : '' }}">
                                <span class="relative z-10">About</span>
                                <div class="absolute inset-0 bg-tra-yellow rounded-lg transform scale-0 group-hover:scale-100 transition-transform duration-300 opacity-10"></div>
                            </a>
                            <a href="{{ route('institutions.index') }}" class="nav-link group relative px-4 py-2 text-tra-black hover:text-tra-yellow transition-all duration-300 font-semibold text-base {{ request()->routeIs('institutions.*') ? 'text-tra-yellow' : '' }}">
                                <span class="relative z-10">Institutions</span>
                                <div class="absolute inset-0 bg-tra-yellow rounded-lg transform scale-0 group-hover:scale-100 transition-transform duration-300 opacity-10"></div>
                            </a>
                            <a href="{{ route('events.index') }}" class="nav-link group relative px-4 py-2 text-tra-black hover:text-tra-yellow transition-all duration-300 font-semibold text-base {{ request()->routeIs('events.*') ? 'text-tra-yellow' : '' }}">
                                <span class="relative z-10">Events</span>
                                <div class="absolute inset-0 bg-tra-yellow rounded-lg transform scale-0 group-hover:scale-100 transition-transform duration-300 opacity-10"></div>
                            </a>
                            <a href="{{ route('funding.index') }}" class="nav-link group relative px-4 py-2 text-tra-black hover:text-tra-yellow transition-all duration-300 font-semibold text-base {{ request()->routeIs('funding.*') ? 'text-tra-yellow' : '' }}">
                        ...
                        <div class="flex items-center space-x-3 sm:space-x-4 animate-fade-in-right">
                            ...
                            <div class="hidden md:flex items-center space-x-3">
                                ...
                                @else
                                    <div class="relative">
                                        <button onclick="toggleDropdown()" class="flex items-center space-x-2 bg-tra-yellow text-tra-black px-5 py-2.5 rounded-lg font-semibold hover:bg-yellow-400 transition-all duration-300">
            ...
            <div id="mobileMenu" class="lg:hidden mobile-menu-hidden transition-all duration-300 ease-in-out bg-white border-t border-gray-200 shadow-lg">
                <div class="px-4 py-6 space-y-4">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('home') }}" onclick="toggleMobileMenu()" class="block text-tra-black hover:text-tra-yellow hover:bg-gray-50 transition-all duration-300 font-semibold text-lg py-4 px-4 rounded-lg border-l-4 {{ request()->routeIs('home') ? 'border-tra-yellow text-tra-yellow' : 'border-transparent' }}">
                        ...
                        <a href="{{ route('about') }}" onclick="toggleMobileMenu()" class="block text-tra-black hover:text-tra-yellow hover:bg-gray-50 transition-all duration-300 font-semibold text-lg py-4 px-4 rounded-lg border-l-4 {{ request()->routeIs('about') ? 'border-tra-yellow text-tra-yellow' : 'border-transparent' }}">
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                                </svg>
                        ...
                        <a href="{{ route('institutions.index') }}" onclick="toggleMobileMenu()" class="block text-tra-black hover:text-tra-yellow hover:bg-gray-50 transition-all duration-300 font-semibold text-lg py-4 px-4 rounded-lg border-l-4 {{ request()->routeIs('institutions.*') ? 'border-tra-yellow text-tra-yellow' : 'border-transparent' }}">
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="{{ route('events.index') }}" onclick="toggleMobileMenu()" class="block text-tra-black hover:text-tra-yellow hover:bg-gray-50 transition-all duration-300 font-semibold text-lg py-4 px-4 rounded-lg border-l-4 {{ request()->routeIs('events.*') ? 'border-tra-yellow text-tra-yellow' : 'border-transparent' }}">
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="{{ route('funding.index') }}" onclick="toggleMobileMenu()" class="block text-tra-black hover:text-tra-yellow hover:bg-gray-50 transition-all duration-300 font-semibold text-lg py-4 px-4 rounded-lg border-l-4 {{ request()->routeIs('funding.*') ? 'border-tra-yellow text-tra-yellow' : 'border-transparent' }}">
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="border-t border-gray-200 pt-4">
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            ...
                            <a href="{{ route('dashboard') }}" class="flex items-center space-x-2 text-gray-600 hover:text-tra-yellow transition-colors duration-300 p-3 bg-gray-50 rounded-lg">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"></path>
                                </svg>
                    ...
                    <div class="border-t border-gray-200 pt-6 space-y-3">
                        @guest
                            <a href="{{ route('login') }}" class="block w-full bg-tra-yellow text-tra-black py-3 rounded-lg font-semibold hover:bg-yellow-400 transition-all duration-300 shadow-md text-center">
                                Login
                            </a>
                            <a href="{{ route('register') }}" class="block w-full border-2 border-tra-black text-tra-black py-3 rounded-lg font-semibold hover:bg-tra-black hover:text-white transition-all duration-300 text-center">
                                Register
                            </a>
                        @else
                            <div class="space-y-2">
                                <a href="{{ route('profile') }}" class="block w-full bg-gray-100 text-gray-800 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-all duration-300 text-center">
                                    Profile
                                </a>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="block w-full bg-red-500 text-white py-3 rounded-lg font-semibold hover:bg-red-600 transition-all duration-300">
                                        Logout
                                    </button>
                                </form>
                            </div>
    ...
    <!-- Main Content -->
        ...
        <section class="relative h-screen overflow-hidden">
            ...
            <div class="absolute inset-0 z-0">
                ...
                <div id="slideshowContainer" class="relative w-full h-full">
                    @if(isset($slides) && count($slides) > 0)
                        ...
                        @endforeach
                    @else
                        <!-- Default slides if no dynamic content -->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="text-left space-y-6 lg:space-y-8">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 animate-scale-in" style="animation-delay: 0.8s;">
                                <a href="{{ route('institutions.index') }}" class="group relative px-8 py-4 bg-tra-yellow text-tra-black font-bold rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-tra-yellow/30">
                                ...
                                <a href="{{ route('about') }}" class="group relative px-8 py-4 border-2 border-tra-yellow text-tra-yellow font-bold rounded-full overflow-hidden transition-all duration-300 hover:text-tra-black">
                            ...
                            <div class="grid grid-cols-3 gap-6 lg:gap-8 pt-8 border-t border-white/10 animate-blur-in" style="animation-delay: 1s;">
                                <div class="text-center lg:text-left">
                                    <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-tra-yellow counter" data-target="{{ $stats['clubs'] ?? 150 }}">0</div>
                                    <div class="text-xs sm:text-sm text-gray-400 uppercase tracking-wider mt-1">Active Clubs</div>
                                </div>
                                <div class="text-center lg:text-left">
                                    <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-tra-yellow counter" data-target="{{ $stats['members'] ?? 25000 }}">0</div>
                                    <div class="text-xs sm:text-sm text-gray-400 uppercase tracking-wider mt-1">Members</div>
                                </div>
                                <div class="text-center lg:text-left">
                                    <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-tra-yellow counter" data-target="{{ $stats['institutions'] ?? 95 }}">0</div>
                                ...
                                <div class="absolute top-0 right-0 glass-panel p-6 rounded-2xl shadow-2xl animate-float max-w-xs">
                                    <div class="flex items-center space-x-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-400 text-sm">Join {{ number_format($stats['members'] ?? 25000) }}+ members</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-xs text-gray-400">+{{ number_format($stats['members'] ?? 25000) }} members</span>
                                    </div>
                                </div>
            ...
            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-40 flex items-center space-x-3">
                @if(isset($slides) && count($slides) > 0)
                    @foreach($slides as $index => $slide)
                        <button class="slide-indicator {{ $index === 0 ? 'w-12 active' : 'w-6' }} h-1 bg-white/30 rounded-full" data-slide="{{ $index }}"></button>
                    @endforeach
                @else
            ...
            <div class="absolute bottom-8 right-8 z-40 hidden lg:block">
                <div class="animate-bounce">
                    <a href="#main-content" class="flex items-center space-x-2 text-white/70 hover:text-tra-yellow transition-colors duration-300">
    ...
    <!-- Main Content Area -->
    <main id="main-content" class="min-h-screen bg-gray-50 {{ request()->routeIs('home') ? '' : 'pt-32' }}">
        @yield('content')
    </main>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="animate-fade-in-up" style="animation-delay: 0.1s;">
                    ...
                    <ul class="space-y-2 sm:space-y-3">
                        <li>
                            <a href="{{ route('institutions.index') }}" class="text-tra-yellow/80 hover:text-tra-yellow transition-colors duration-300 flex items-center space-x-2 text-sm sm:text-base">
                                <span class="text-xs">→</span>
                                <span>Partner Institutions</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('events.index') }}" class="text-tra-yellow/80 hover:text-tra-yellow transition-colors duration-300 flex items-center space-x-2 text-sm sm:text-base">
                                <span class="text-xs">→</span>
                                <span>Upcoming Events</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('funding.index') }}" class="text-tra-yellow/80 hover:text-tra-yellow transition-colors duration-300 flex items-center space-x-2 text-sm sm:text-base">
                                <span class="text-xs">→</span>
                ...
                <div class="animate-fade-in-up" style="animation-delay: 0.3s;">
                    ...
                    <div class="mt-6 p-3 sm:p-4 bg-tra-yellow/10 rounded-xl">
                        ...
                        <form action="{{ route('newsletter.subscribe') }}" method="POST" class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                            @csrf
                            <input 
                                type="email" 
                                name="email"
                            ...
                            >
                            <button type="submit" class="bg-tra-yellow text-tra-black px-4 py-2 rounded-lg text-sm font-bold hover:bg-yellow-400 transition-colors duration-300 whitespace-nowrap">
                                Subscribe
                            </button>
                        </form>
                    </div>
            ...
            <div class="border-t border-tra-yellow/20 mt-8 sm:mt-12 pt-6 sm:pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <p class="text-tra-yellow/70 text-sm sm:text-base text-center md:text-left">
                        &copy; {{ date('Y') }} TRA Clubs Management System. All rights reserved.
                    </p>
                    <div class="flex flex-wrap justify-center md:justify-end space-x-4 sm:space-x-6 text-xs sm:text-sm">
                        <a href="{{ route('privacy') }}" class="text-tra-yellow/70 hover:text-tra-yellow transition-colors duration-300">Privacy Policy</a>
                        <a href="{{ route('terms') }}" class="text-tra-yellow/70 hover:text-tra-yellow transition-colors duration-300">Terms of Service</a>
                        <a href="{{ route('cookies') }}" class="text-tra-yellow/70 hover:text-tra-yellow transition-colors duration-300">Cookie Policy</a>
                        <a href="{{ route('support') }}" class="text-tra-yellow/70 hover:text-tra-yellow transition-colors duration-300">Support</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!dropdownButton && dropdown && !dropdown.contains(e.target)) {
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!menuButton && mobileMenu && !mobileMenu.contains(e.target) && !mobileMenu.classList.contains('mobile-menu-hidden')) {
                toggleMobileMenu();
            }
        });
